=== appful Mobile App Plugin [OLD - NEW VERSION BELOW] ===
...
**This version of the appful plugin is old and will not be supported in the future. Please use our new plugin that can be found here: [https://wordpress.org/plugins/appful-app](https://wordpress.org/plugins/appful-app)**
